...
class Admin{
    ...
    function ListaPodstron() {
        ...
        echo '<tr><td colspan="4"><button><a class="create_page" href="?idp=-4">Stwórz nową stronę</button></a></td></tr>';
        echo '<tr><td colspan="4"><button><a href="index.php?idp=-8">Kategorie w sklepie</button></a></td></tr>';
        echo '<tr><td colspan="4"><button><a href="index.php?idp=-12">Produkty w sklepie</button></a></td></tr>';
